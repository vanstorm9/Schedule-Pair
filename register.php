...
<html lang="en">
  <head>
    ...
    <title>RU Schedule Pair Registration</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" name='registration' method='post' action='register_back.php'>
        <h2><font style='color:#FAFAFA;'>Register a RU Schedule Pair Account</font></h2>
		...
		<input type="text" name='major_box' class="form-control" placeholder="Major" required autofocus><br>
		...
		<select class="form-control" name='rutgers_box'>
			<option value="" disabled selected>You're in Rutgers. . . </option>
			<option value="1">Rutgers New Brunswick</option>
			<option value="2">Rutgers Newark</option>
			<option value="3">Rutgers Cadmen</option>
		</select><br>
		<select class="form-control" name='class_box'>
			<option value="" disabled selected>You're in Rutgers the Class of. . .</option>
